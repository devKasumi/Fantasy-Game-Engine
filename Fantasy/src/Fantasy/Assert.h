...
//
//	// Alteratively we could use the same "default" message for both "WIDTH_MSG" and "NO_MSG and
//	// provide support for custom formatting by concatenating the formatting string instead of heaving the format inside the default message 
